...
from SolutionEnv import set_camera_new_focal
...
def __main__():
    ...
    # trying new focal lengths
    #print(f"old camera matrix is: {utils.global_camera_matrix}")
    # set_camera_new_focal(main_gaze_manager.focal_lengths)
    # print(f"new camera matrix is: {utils.global_camera_matrix}")
